...
export async function exportToExcel() {
  ...
  worksheet.columns = [
    ...
    { header: "Kabupaten", key: "regency", width: 25 },
    { header: "Kecamatan", key: "district", width: 25 },
    { header: "Alamat", key: "address", width: 30 },
    { header: "Telp/HP", key: "phone", width: 15 },
    { header: "Email", key: "email", width: 25 },
    { header: "Tgl Lahir", key: "birthDate", width: 15 },
    { header: "Usia", key: "age", width: 10 },
    { header: "Pendapatan", key: "income", width: 15 },
  ...
  people.forEach((person, index) => {
    ...
    worksheet.addRow({
      ...
      nik: person.nik,
      name: person.name,
      province: `${person.provinceCode} - ${person.provinceName}`,
      regency: `${person.regencyCode} - ${person.regencyName}`,
      district: `${person.districtCode} - ${person.districtName}`,
  ...
  // Return the buffer for client-side download
  return buffer
}
...
export async function exportRecapToExcel(recapType, filters) {
  ...
  if (recapType === "age") {
    worksheet.columns = [
      { header: "Range Usia", key: "label", width: 20 },
      { header: "Jumlah", key: "count", width: 15 },
      { header: "Persentase", key: "percentage", width: 15 },
    ]
  } else if (recapType === "income") {
    worksheet.columns = [
      { header: "Range Pendapatan", key: "label", width: 30 },
      { header: "Jumlah", key: "count", width: 15 },
      { header: "Persentase", key: "percentage", width: 15 },
    ]
  } else if (recapType === "education") {
    worksheet.columns = [
      { header: "Tingkat Pendidikan", key: "education", width: 20 },
      { header: "Jumlah", key: "count", width: 15 },
      { header: "Persentase", key: "percentage", width: 15 },
    ]
